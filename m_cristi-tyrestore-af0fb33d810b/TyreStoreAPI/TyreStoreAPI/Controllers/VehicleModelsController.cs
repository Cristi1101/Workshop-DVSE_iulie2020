...
namespace TyreStoreAPI.Controllers
{
    ...
    public class VehicleModelsController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<VehicleModels>>> UpdateVehicleModel([FromBody] VehicleModels model)
        {
            ...
            {
                if (!VehicleModelsExists(model.Id))
                {
                    return NotFound();
                }
                else
        ...
        public async Task<ActionResult<IEnumerable<VehicleModels>>> CreateVehicleModel([FromBody] VehicleModels model)
        {
            ...
            _context.Database.ExecuteSqlCommand("SET IDENTITY_INSERT vehicle_models ON");

            await _context.SaveChangesAsync();

            _context.Database.ExecuteSqlCommand("SET IDENTITY_INSERT vehicle_models OFF");
